...
import { todos } from "./helpers/reducer";
import * as actionCreators from "./helpers/action-creators";
...
describe("bindActionCreators", () => {
  ...
  test("wraps the action creators with the dispatch function", () => {
  ...
  test("wraps action creators transparently", () => {
    const uniqueThis = {};
  ...
  test("skips non-function values in the passed object", () => {
  ...
  test("supports wrapping a single function only", () => {
  ...
  test("throws for an undefined actionCreator", () => {
    expect(() => {
  ...
  test("throws for a null actionCreator", () => {
    expect(() => {
  ...
  test("throws for a primitive actionCreator", () => {
    expect(() => {
      bindActionCreators(
